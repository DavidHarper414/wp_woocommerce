...
try {
    ...
    // @ts-ignore
    Tooltip.__docgenInfo = { "description": "", "displayName": "Tooltip", "props": { "helperText": { "defaultValue": { value: "__( 'Help', 'woocommerce' )" }, "description": "", "name": "helperText", "required": false, "type": { "name": "string" } }, "position": { "defaultValue": { value: "top center" }, "description": "", "name": "position", "required": false, "type": { "name": "enum", "value": [{ "value": "\"top center\"" }, { "value": "\"top left\"" }, { "value": "\"top right\"" }, { "value": "\"bottom center\"" }, { "value": "\"bottom left\"" }, { "value": "\"bottom right\"" }, { "value": "\"middle center\"" }, { "value": "\"middle left\"" }, { "value": "\"middle right\"" }] } }, "text": { "defaultValue": null, "description": "", "name": "text", "required": true, "type": { "name": "string | Element" } }, "className": { "defaultValue": { value: "" }, "description": "", "name": "className", "required": false, "type": { "name": "string" } } } };
    // @ts-ignore
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@wordpress+icons@10.6.0_react@18.3.1/node_modules/@wordpress/icons/build-module/icon/index.js
/**
 * WordPress dependencies
 */
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@wordpress+icons@10.6.0_react@18.3.1/node_modules/@wordpress/icons/build-module/library/help.js
/**
 * WordPress dependencies
 */
...
var Label = function Label(_ref) {
  ...
  if (required) {
    if (note !== null && note !== void 0 && note.length) {
      labelElement = (0,create_interpolate_element/* default */.A)((0,build_module.__)('<label/> <note /> <required/>', 'woocommerce'), {
        ...
        note: /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
          className: "woocommerce-product-form-label__note",
          children: note
        }),
        required: /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
          "aria-hidden": "true",
          className: "woocommerce-product-form-label__required",
          children: (0,build_module.__)('*', 'woocommerce')
        })
      });
    } else {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("span", _objectSpread(_objectSpread({
      id: labelId,
      onClick: onClick
    }, spanAdditionalProps), {}, {
      children: (0,react.isValidElement)(labelElement) ? labelElement : null
    })), tooltip && /*#__PURE__*/(0,jsx_runtime.jsx)(tooltip_tooltip/* Tooltip */.m, {
...
function label_story_ownKeys(e, r) {
  var t = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var o = Object.getOwnPropertySymbols(e);
    r && (o = o.filter(function (r) {
...
function label_story_objectSpread(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2 ? label_story_ownKeys(Object(t), !0).forEach(function (r) {
      (0,defineProperty/* default */.A)(e, r, t[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : label_story_ownKeys(Object(t)).forEach(function (r) {
      Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
    });
  }
  return e;
...
var Default = function Default(args) {
  return /*#__PURE__*/(0,jsx_runtime.jsx)(Label, label_story_objectSpread({}, args));
};
Default.parameters = {
  ...Default.parameters,
  docs: {
