"use strict";
(self["webpackChunk_woocommerce_storybook"] = self["webpackChunk_woocommerce_storybook"] || []).push([[8472],{
...
var LightbulbStage = {
  title: (0,build_module.__)('Turning on the lights', 'woocommerce'),
  image: /*#__PURE__*/(0,jsx_runtime.jsx)("img", {
    src: loader_lightbulb_namespaceObject,
    alt: "loader-lightbulb"
  }),
  paragraphs: [{
    label: (0,build_module.__)('#FunWooFact: ', 'woocommerce'),
    text: (0,build_module.__)('Explore powerful extensions and themes at WooCommerce.com to enhance your store.', 'woocommerce')
  }, {
    label: (0,build_module.__)('#FunWooFact: ', 'woocommerce'),
    text: (0,build_module.__)('The Woo team is made up of over 350 talented individuals, distributed across 30+ countries.', 'woocommerce')
  }]
};
var LayoutStage = {
  title: (0,build_module.__)('Extending your store’s capabilities', 'woocommerce'),
  image: /*#__PURE__*/(0,jsx_runtime.jsx)("img", {
    src: loader_layout_namespaceObject,
    alt: "loader-lightbulb"
  }),
  paragraphs: [{
    label: (0,build_module.__)('#FunWooFact: ', 'woocommerce'),
    text: (0,build_module.__)('Did you know that Woo powers almost 4 million stores worldwide? You’re in good company.', 'woocommerce')
  }]
};
var DevelopingStage = {
  title: (0,build_module.__)('Woo! Let’s get your features ready', 'woocommerce'),
  image: /*#__PURE__*/(0,jsx_runtime.jsx)("img", {
    src: loader_developing_namespaceObject,
    alt: "loader-developng"
  }),
  paragraphs: [{
    label: (0,build_module.__)('#FunWooFact: ', 'woocommerce'),
    text: (0,build_module.__)('Did you know that Woo was founded by two South Africans and a Norwegian? Here are three alternative ways to say “store” in those countries – Winkel, ivenkile, and butikk.', 'woocommerce')
  }]
};
var OpeningTheDoorsStage = {
  title: (0,build_module.__)('Opening the doors', 'woocommerce'),
  image: /*#__PURE__*/(0,jsx_runtime.jsx)("img", {
    src: loader_openingthedoors_namespaceObject,
    alt: "loader-opening-the-doors"
  }),
  paragraphs: [{
    label: (0,build_module.__)('#FunWooFact: ', 'woocommerce'),
    text: (0,build_module.__)('Our favorite color is purple ', 'woocommerce'),
    element: /*#__PURE__*/(0,jsx_runtime.jsx)("img", {
      src: loader_hearticon_namespaceObject,
      alt: "loader-hearticon",
      className: "loader-hearticon"
    })
  }]
};
var getLoaderStageMeta = function getLoaderStageMeta(key) {
  switch (key) {
    case 'plugins':
...
try {
    // @ts-ignore
    getLoaderStageMeta.displayName = "getLoaderStageMeta";
    // @ts-ignore
    getLoaderStageMeta.__docgenInfo = { "description": "", "displayName": "getLoaderStageMeta", "props": {} };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../plugins/woocommerce/client/admin/client/core-profiler/utils/get-loader-stage-meta.tsx#getLoaderStageMeta"] = { docgenInfo: getLoaderStageMeta.__docgenInfo, name: "getLoaderStageMeta", path: "../../plugins/woocommerce/client/admin/client/core-profiler/utils/get-loader-stage-meta.tsx#getLoaderStageMeta" };
}
catch (__react_docgen_typescript_loader_error) { }
;// CONCATENATED MODULE: ../../plugins/woocommerce/client/admin/client/core-profiler/components/loader/Loader.tsx
...
var CoreProfilerLoader = function CoreProfilerLoader(_ref) {
  var _context$loader$useSt, _context$loader$stage, _context$loader$progr, _context$loader;
  var context = _ref.context;
  var stages = getLoaderStageMeta((_context$loader$useSt = context.loader.useStages) !== null && _context$loader$useSt !== void 0 ? _context$loader$useSt : 'default');
  var currentStage = stages[(_context$loader$stage = context.loader.stageIndex) !== null && _context$loader$stage !== void 0 ? _context$loader$stage : 0];
  return /*#__PURE__*/(0,jsx_runtime.jsx)(src/* Loader */.aH, {
    className: context.loader.className,
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)(src/* Loader */.aH.Layout, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(src/* Loader */.aH.Illustration, {
        children: currentStage.image
      }), /*#__PURE__*/(0,jsx_runtime.jsx)(src/* Loader */.aH.Title, {
        children: currentStage.title
      }), /*#__PURE__*/(0,jsx_runtime.jsx)(src/* Loader */.aH.ProgressBar, {
        progress: (_context$loader$progr = (_context$loader = context.loader) === null || _context$loader === void 0 ? void 0 : _context$loader.progress) !== null && _context$loader$progr !== void 0 ? _context$loader$progr : 0
      }), /*#__PURE__*/(0,jsx_runtime.jsx)(src/* Loader */.aH.Sequence, {
        interval: 3000,
        children: currentStage.paragraphs.map(function (paragraph, index) {
          return /*#__PURE__*/(0,jsx_runtime.jsxs)(src/* Loader */.aH.Subtext, {
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)("b", {
              children: paragraph === null || paragraph === void 0 ? void 0 : paragraph.label
            }), paragraph === null || paragraph === void 0 ? void 0 : paragraph.text, paragraph === null || paragraph === void 0 ? void 0 : paragraph.element]
          }, index);
        })
      })]
    })
...
try {
    // @ts-ignore
    CoreProfilerLoader.displayName = "CoreProfilerLoader";
    // @ts-ignore
    CoreProfilerLoader.__docgenInfo = { "description": "", "displayName": "CoreProfilerLoader", "props": { "context": { "defaultValue": null, "description": "", "name": "context", "required": true, "type": { "name": "LoaderContextProps" } } } };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../plugins/woocommerce/client/admin/client/core-profiler/components/loader/Loader.tsx#CoreProfilerLoader"] = { docgenInfo: CoreProfilerLoader.__docgenInfo, name: "CoreProfilerLoader", path: "../../plugins/woocommerce/client/admin/client/core-profiler/components/loader/Loader.tsx#CoreProfilerLoader" };
}
catch (__react_docgen_typescript_loader_error) { }
...
;// CONCATENATED MODULE: ../../plugins/woocommerce/client/admin/client/core-profiler/stories/Loader.story.tsx
/**
 * Internal dependencies
 */
...
var Short = function Short() {
  return /*#__PURE__*/(0,jsx_runtime.jsx)(CoreProfilerLoader, {
    context: {
      loader: {
        progress: 10,
        useStages: 'skipGuidedSetup'
      }
    }
  });
};
...
Short.parameters = {
  ...Short.parameters,
  docs: {
    ...Short.parameters?.docs,
    source: {
      originalSource: "() => <CoreProfilerLoader context={{\n  loader: {\n    progress: 10,\n    useStages: 'skipGuidedSetup'\n  }\n}} />",
      ...Short.parameters?.docs?.source
    }
  }
};
Plugins.parameters = {
  ...Plugins.parameters,
  docs: {
    ...Plugins.parameters?.docs,
    source: {
      originalSource: "() => <CoreProfilerLoader context={{\n  loader: {\n    progress: 10,\n    useStages: 'plugins'\n  }\n}} />",
      ...Plugins.parameters?.docs?.source
    }
  }
};
