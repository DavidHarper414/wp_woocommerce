"use strict";
(self["webpackChunk_woocommerce_storybook"] = self["webpackChunk_woocommerce_storybook"] || []).push([[5655],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  MultipleChildren: () => (/* binding */ MultipleChildren),
  "default": () => (/* binding */ advice_card_story)
});
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@wordpress+icons@10.6.0_react@18.3.1/node_modules/@wordpress/icons/build-module/library/close.js
var library_close = __webpack_require__("../../node_modules/.pnpm/@wordpress+icons@10.6.0_react@18.3.1/node_modules/@wordpress/icons/build-module/library/close.js");
// EXTERNAL MODULE: ../../packages/js/data/src/index.ts + 180 modules
...
;// CONCATENATED MODULE: ../../packages/js/product-editor/src/components/advice-card/advice-card.tsx
...
var _excluded = ["tip", "isDismissible", "dismissPreferenceId", "className", "children", "onDismiss"];
...
function AdviceCard(_ref) {
  ...
  var _useUserPreferences = (0,src/* useUserPreferences */.HW)(),
    updateUserPreferences = _useUserPreferences.updateUserPreferences,
    product_advice_card_dismissed = _useUserPreferences.product_advice_card_dismissed;
  function handleDismissButtonClick() {
    if (dismissPreferenceId) {
      updateUserPreferences({
        product_advice_card_dismissed: _objectSpread(_objectSpread({}, product_advice_card_dismissed), {}, (0,defineProperty/* default */.A)({}, dismissPreferenceId, 'yes'))
      });
    } else {
      setIsDismissed(function (current) {
        return !current;
      });
    }
    if (onDismiss) {
  ...
  if (isDismissible) {
    if (dismissPreferenceId && product_advice_card_dismissed && (product_advice_card_dismissed === null || product_advice_card_dismissed === void 0 ? void 0 : product_advice_card_dismissed[dismissPreferenceId]) === 'yes') {
      return null;
    }
    if (isDismissed) {
      return null;
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", _objectSpread(_objectSpread({
    ...
    className: classnames_default()(className, 'woocommerce-advice-card', {
      'is-dismissible': isDismissible
    }),
    children: [isDismissible && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      className: "woocommerce-advice-card__header",
      children: /*#__PURE__*/(0,jsx_runtime.jsx)(build_module_button/* default */.Ay, {
        ...
        label: (0,build_module.__)('Dismiss', 'woocommerce'),
        isSmall: true
      })
    }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      className: "woocommerce-advice-card__body",
      children: children
    }), tip && tip.length > 0 && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      className: "woocommerce-advice-card__footer",
      children: tip
    })]
  }));
}
try {
    ...
    // @ts-ignore
    AdviceCard.__docgenInfo = { "description": "", "displayName": "AdviceCard", "props": { "tip": { "defaultValue": null, "description": "", "name": "tip", "required": false, "type": { "name": "string" } }, "isDismissible": { "defaultValue": { value: "true" }, "description": "", "name": "isDismissible", "required": false, "type": { "name": "boolean" } }, "dismissPreferenceId": { "defaultValue": null, "description": "", "name": "dismissPreferenceId", "required": false, "type": { "name": "string" } }, "onDismiss": { "defaultValue": null, "description": "", "name": "onDismiss", "required": false, "type": { "name": "(() => void)" } } } };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/product-editor/src/components/advice-card/advice-card.tsx#AdviceCard"] = { docgenInfo: AdviceCard.__docgenInfo, name: "AdviceCard", path: "../../packages/js/product-editor/src/components/advice-card/advice-card.tsx#AdviceCard" };
}
catch (__react_docgen_typescript_loader_error) { }
// EXTERNAL MODULE: ../../packages/js/product-editor/src/images/shopping-bags/index.tsx
var shopping_bags = __webpack_require__("../../packages/js/product-editor/src/images/shopping-bags/index.tsx");
// EXTERNAL MODULE: ../../packages/js/product-editor/src/images/shirt/index.tsx
var shirt = __webpack_require__("../../packages/js/product-editor/src/images/shirt/index.tsx");
// EXTERNAL MODULE: ../../packages/js/product-editor/src/images/pants/index.tsx
var pants = __webpack_require__("../../packages/js/product-editor/src/images/pants/index.tsx");
// EXTERNAL MODULE: ../../packages/js/product-editor/src/images/glasses/index.tsx
var glasses = __webpack_require__("../../packages/js/product-editor/src/images/glasses/index.tsx");
;// CONCATENATED MODULE: ../../packages/js/product-editor/src/components/advice-card/stories/advice-card.story.tsx
...
function advice_card_story_ownKeys(e, r) {
  var t = Object.keys(e);
  if (Object.getOwnPropertySymbols) {
    var o = Object.getOwnPropertySymbols(e);
    r && (o = o.filter(function (r) {
...
function advice_card_story_objectSpread(e) {
  for (var r = 1; r < arguments.length; r++) {
    var t = null != arguments[r] ? arguments[r] : {};
    r % 2 ? advice_card_story_ownKeys(Object(t), !0).forEach(function (r) {
      (0,defineProperty/* default */.A)(e, r, t[r]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : advice_card_story_ownKeys(Object(t)).forEach(function (r) {
      Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
    });
  }
  return e;
...
/* harmony default export */ const advice_card_story = ({
  title: 'Product Editor/components/AdviceCard',
  component: AdviceCard
});
var Default = function Default(args) {
  return /*#__PURE__*/(0,jsx_runtime.jsx)(AdviceCard, advice_card_story_objectSpread({}, args));
};
Default.args = {
  // @todo: use an addon
  ...
  tip: (0,build_module.__)('Tip: Upsells are typically products that are extra profitable or better quality or more expensive. Experiment with combinations to boost sales.', 'woocommerce'),
  children: /*#__PURE__*/(0,jsx_runtime.jsx)(shopping_bags/* ShoppingBags */.M, {}),
  isDismissible: true
};
var MultipleChildren = function MultipleChildren(args) {
  return /*#__PURE__*/(0,jsx_runtime.jsx)(AdviceCard, advice_card_story_objectSpread({}, args));
};
MultipleChildren.args = {
  tip: (0,build_module.__)('Tip: Group together items that have a clear relationship or compliment each other well, e.g., garment bundles, camera kits, or skincare product sets.', 'woocommerce'),
  children: /*#__PURE__*/(0,jsx_runtime.jsxs)(component/* default */.A, {
    justify: "center",
    style: {
      gap: '16px '
    },
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(shirt/* Shirt */.d, {}), /*#__PURE__*/(0,jsx_runtime.jsx)(pants/* Pants */.t, {}), /*#__PURE__*/(0,jsx_runtime.jsx)(glasses/* Glasses */.l, {})]
  }),
  isDismissible: false,
...
Default.parameters = {
  ...
  docs: {
    ...
    source: {
      originalSource: "(args: AdviceCardProps) => <AdviceCard {...args} />",
...
MultipleChildren.parameters = {
  ...MultipleChildren.parameters,
  docs: {
    ...MultipleChildren.parameters?.docs,
    source: {
      originalSource: "(args: AdviceCardProps) => <AdviceCard {...args} />",
      ...MultipleChildren.parameters?.docs?.source
    }
  }
};
try {
    ...
    // @ts-ignore
    Default.__docgenInfo = { "description": "", "displayName": "Default", "props": { "tip": { "defaultValue": null, "description": "", "name": "tip", "required": false, "type": { "name": "string" } }, "isDismissible": { "defaultValue": null, "description": "", "name": "isDismissible", "required": false, "type": { "name": "boolean" } }, "dismissPreferenceId": { "defaultValue": null, "description": "", "name": "dismissPreferenceId", "required": false, "type": { "name": "string" } }, "onDismiss": { "defaultValue": null, "description": "", "name": "onDismiss", "required": false, "type": { "name": "(() => void)" } } } };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/product-editor/src/components/advice-card/stories/advice-card.story.tsx#Default"] = { docgenInfo: Default.__docgenInfo, name: "Default", path: "../../packages/js/product-editor/src/components/advice-card/stories/advice-card.story.tsx#Default" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
    MultipleChildren.displayName = "MultipleChildren";
    // @ts-ignore
    MultipleChildren.__docgenInfo = { "description": "", "displayName": "MultipleChildren", "props": { "tip": { "defaultValue": null, "description": "", "name": "tip", "required": false, "type": { "name": "string" } }, "isDismissible": { "defaultValue": null, "description": "", "name": "isDismissible", "required": false, "type": { "name": "boolean" } }, "dismissPreferenceId": { "defaultValue": null, "description": "", "name": "dismissPreferenceId", "required": false, "type": { "name": "string" } }, "onDismiss": { "defaultValue": null, "description": "", "name": "onDismiss", "required": false, "type": { "name": "(() => void)" } } } };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["../../packages/js/product-editor/src/components/advice-card/stories/advice-card.story.tsx#MultipleChildren"] = { docgenInfo: MultipleChildren.__docgenInfo, name: "MultipleChildren", path: "../../packages/js/product-editor/src/components/advice-card/stories/advice-card.story.tsx#MultipleChildren" };
}
catch (__react_docgen_typescript_loader_error) { }
