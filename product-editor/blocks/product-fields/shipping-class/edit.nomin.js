...
exports.DEFAULT_SHIPPING_CLASS_OPTIONS = void 0;
exports.Edit = Edit;
/**
...
function Edit({ attributes, context: { postType, isInSelectedTab }, }) {
    ...
    const { createProductShippingClass } = (0, data_2.useDispatch)(data_1.experimentalProductShippingClassesStore);
    ...
    const { shippingClasses } = (0, data_2.useSelect)((select) => {
        const { getProductShippingClasses } = select(data_1.experimentalProductShippingClassesStore);
        return {
