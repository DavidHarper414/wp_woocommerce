...
<div class="wp-block-woocommerce-coming-soon woocommerce-coming-soon-entire-site woocommerce-coming-soon-minimal-left-image has-background" style="background-color:#f9f9f9">


<!-- wp:cover {"customOverlayColor":"transparent","isUserOverlayColor":true,"minHeight":100,"minHeightUnit":"vh","className":"coming-soon-is-vertically-aligned-center coming-soon-cover","style":{"spacing":{"padding":{"top":"0px","bottom":"0px","left":"24px","right":"24px"}}},"layout":{"type":"default"}} -->
<div class="wp-block-cover coming-soon-is-vertically-aligned-center coming-soon-cover" style="padding-top:0px;padding-right:24px;padding-bottom:0px;padding-left:24px;min-height:100vh"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-100 has-background-dim" style="background-color:transparent"></span><div class="wp-block-cover__inner-container"><!-- wp:group {"align":"full","style":{"dimensions":{"minHeight":"100vh"}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-group"><!-- wp:paragraph {"className":"has-<?php echo esc_html( $paragraph_font_family ?? '' ); ?>-font-family","style":{"color":{"text":"#000"},"elements":{"link":{"color":{"text":"#000"}}},"typography":{"lineHeight":"1.6","letterSpacing":"0px"}},"fontFamily":"<?php echo esc_html( $paragraph_font_family ?? '' ); ?>"} -->
<p class="has-<?php echo esc_html( $paragraph_font_family ?? '' ); ?>-font-family has-text-color has-link-color" style="color:#000;letter-spacing:0px;line-height:1.6"><?php echo esc_html( $store_description ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
