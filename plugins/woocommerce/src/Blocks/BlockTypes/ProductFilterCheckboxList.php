...
final class ProductFilterCheckboxList extends AbstractBlock {
	...
	protected function render( $attributes, $content, $block ) {
		...
		$wrapper_attributes = array(
			'data-wp-interactive' => esc_attr( wp_json_encode( array( 'namespace' => 'woocommerce/product-filter-checkbox-list' ), JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP ) ),
