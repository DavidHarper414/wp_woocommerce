...
class WC_Product_Variable_Data_Store_CPT_Test extends WC_Unit_Test_Case {
	...
	public function test_validate_children_data() {
		...
		$this->assertTrue(
			$this->invokeMethod( $data_store, 'validate_children_data', array( $valid_children ) ),
			'Valid children data should pass validation'
		);

		// Test invalid data type.
		$this->assertFalse(
			$this->invokeMethod( $data_store, 'validate_children_data', array( 'not an array' ) ),
		...
		$this->assertFalse(
			$this->invokeMethod( $data_store, 'validate_children_data', array( $missing_keys ) ),
		...
		$this->assertFalse(
			$this->invokeMethod( $data_store, 'validate_children_data', array( $invalid_child_id ) ),
		...
		$this->assertFalse(
			$this->invokeMethod( $data_store, 'validate_children_data', array( $invalid_arrays ) ),
			'Non-array values for all/visible should fail validation'
		);

		// Test empty children data (new product, should pass).
		...
		$this->assertFalse(
			$this->invokeMethod( $data_store, 'validate_children_data', array( $empty_children ) ),
			'Empty children data should fail validation as likely corrupt'
		);
		...
		$this->assertFalse(
			$this->invokeMethod( $data_store, 'validate_children_data', array( $uninitialized_children ) ),
