...
wp-env run tests-cli wp post create --post_type=page --post_status=publish --post_title='Confirmation email' --post_name='confirmation-email' --post_content='[bis_confirmation_received_email]'
wp-env run tests-cli wp post create --post_type=page --post_status=publish --post_title='Verification email' --post_name='verification-email' --post_content='[bis_verify_received_email]'
wp-env run tests-cli wp post create --post_type=page --post_status=publish --post_title='Notification email' --post_name='notification-email' --post_content='[bis_notification_received_email]'
