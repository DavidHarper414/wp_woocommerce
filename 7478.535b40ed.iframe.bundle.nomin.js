(self["webpackChunk_woocommerce_storybook"] = self["webpackChunk_woocommerce_storybook"] || []).push([[7478],{
...
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("../../node_modules/.pnpm/@wordpress+components@28.0.3_@emotion+is-prop-valid@1.2.1_@types+react@18.3.16_react-dom@18.3_mbjd55jx3gsragjgwncwdigc7u/node_modules/@wordpress/components/build-module/button/index.js");
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("../../node_modules/.pnpm/prop-types@15.8.1/node_modules/prop-types/index.js");
...
var EmptyContent = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)(EmptyContent, _Component);
  var _super = _createSuper(EmptyContent);
  function EmptyContent() {
    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .A)(this, EmptyContent);
    return _super.apply(this, arguments);
  }
  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A)(EmptyContent, [{
    ...
    value: function renderActionButtons(type) {
      ...
      if (actionURL && actionCallback) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Ay, {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
        ...
        children: [illustration && this.renderIllustration(), title ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_section__WEBPACK_IMPORTED_MODULE_10__.H, {
          className: "woocommerce-empty-content__title",
          children: title
        }) : null, message ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("p", {
...
EmptyContent.propTypes = {
   ...
   */
  message: (prop_types__WEBPACK_IMPORTED_MODULE_12___default().node),
  /**
   * The url string of an image path for img src.
   */
  illustration: (prop_types__WEBPACK_IMPORTED_MODULE_12___default().string),
  /**
   * Height to use for the illustration.
   */
  illustrationHeight: (prop_types__WEBPACK_IMPORTED_MODULE_12___default().number),
  /**
   * Width to use for the illustration.
   */
  illustrationWidth: (prop_types__WEBPACK_IMPORTED_MODULE_12___default().number),
  /**
   * Label to be used for the primary action button.
   */
  actionLabel: (prop_types__WEBPACK_IMPORTED_MODULE_12___default().string).isRequired,
  /**
   * URL to be used for the primary action button.
   */
  actionURL: (prop_types__WEBPACK_IMPORTED_MODULE_12___default().string),
  /**
   * Callback to be used for the primary action button.
   */
  actionCallback: (prop_types__WEBPACK_IMPORTED_MODULE_12___default().func),
  /**
   * Label to be used for the secondary action button.
   */
  secondaryActionLabel: (prop_types__WEBPACK_IMPORTED_MODULE_12___default().string),
  /**
   * URL to be used for the secondary action button.
   */
  secondaryActionURL: (prop_types__WEBPACK_IMPORTED_MODULE_12___default().string),
  /**
   * Callback to be used for the secondary action button.
   */
  secondaryActionCallback: (prop_types__WEBPACK_IMPORTED_MODULE_12___default().func),
  /**
