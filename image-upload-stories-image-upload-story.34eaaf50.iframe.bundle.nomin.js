...
// EXTERNAL MODULE: ../../node_modules/.pnpm/core-js@3.34.0/node_modules/core-js/modules/web.url.to-json.js
var web_url_to_json = __webpack_require__("../../node_modules/.pnpm/core-js@3.34.0/node_modules/core-js/modules/web.url.to-json.js");
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@wordpress+icons@10.0.2_react@18.3.1/node_modules/@wordpress/icons/build-module/library/upload.js
var upload = __webpack_require__("../../node_modules/.pnpm/@wordpress+icons@10.0.2_react@18.3.1/node_modules/@wordpress/icons/build-module/library/upload.js");
// EXTERNAL MODULE: ../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__("../../node_modules/.pnpm/react@18.3.1/node_modules/react/jsx-runtime.js");
;// CONCATENATED MODULE: ../../packages/js/components/src/image-upload/index.js
...
var ImageUpload = /*#__PURE__*/function (_Component) {
  (0,inherits/* default */.A)(ImageUpload, _Component);
  var _super = _createSuper(ImageUpload);
  function ImageUpload() {
    var _this;
    (0,classCallCheck/* default */.A)(this, ImageUpload);
    _this = _super.apply(this, arguments);
    _this.state = {
      frame: false
    };
    _this.openModal = _this.openModal.bind((0,assertThisInitialized/* default */.A)(_this));
    _this.handleImageSelect = _this.handleImageSelect.bind((0,assertThisInitialized/* default */.A)(_this));
    _this.removeImage = _this.removeImage.bind((0,assertThisInitialized/* default */.A)(_this));
    return _this;
  }
  (0,createClass/* default */.A)(ImageUpload, [{
    key: "openModal",
    ...
    value: function handleImageSelect() {
      var onChange = this.props.onChange;
      var attachment = this.state.frame.state().get('selection').first().toJSON();
      onChange(attachment);
    }
  }, {
    key: "removeImage",
...
;// CONCATENATED MODULE: ../../packages/js/components/src/image-upload/stories/image-upload.story.js
...
var ImageUploadExample = function ImageUploadExample() {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(image_upload, {
    image: image,
    onChange: function onChange(_image) {
      return setImage(_image);
    }
  });
};
var Basic = function Basic() {
  return /*#__PURE__*/(0,jsx_runtime.jsx)(ImageUploadExample, {});
};
